DECLARE
  CURSOR C IS
    ...
    FROM (
      SELECT
        ...
        '0' AS NR_SECTIE2,
        '0' AS NUME_SECTIE2,
        VB.COL2 || '~' || VB.ORDINE || '_' || CASE WHEN VB.R401 IS NULL THEN 1 ELSE 2 END AS NR_ROW,
        VB.ORDINE,
  ...
  SUM(DD.R301_1) AS COL2,
  SUM(DD.R302_1) AS COL3,
  SUM(DD.R303_1) AS COL4,
  SUM(DD.R304_1) AS COL5,
  SUM(DD.R305_1) AS COL6,
  SUM(DD.R305_2) AS COL7,
...
--  D.CAPITOL,
  ...
  SUM(CASE WHEN D.RIND IN ('201') THEN CIS2.NVAL(D.COL1) ELSE NULL END) AS R201_1,
  SUM(CASE WHEN D.RIND IN ('201') THEN CIS2.NVAL(D.COL2) ELSE NULL END) AS R201_2,
  SUM(CASE WHEN D.RIND IN ('201') THEN CIS2.NVAL(D.COL3) ELSE NULL END) AS R201_3,
  SUM(CASE WHEN D.RIND IN ('202') THEN CIS2.NVAL(D.COL1) ELSE NULL END) AS R202_1,
  SUM(CASE WHEN D.RIND IN ('202') THEN CIS2.NVAL(D.COL2) ELSE NULL END) AS R202_2,
  SUM(CASE WHEN D.RIND IN ('202') THEN CIS2.NVAL(D.COL3) ELSE NULL END) AS R202_3,
  SUM(CASE WHEN D.RIND IN ('203') THEN CIS2.NVAL(D.COL1) ELSE NULL END) AS R203_1,
  SUM(CASE WHEN D.RIND IN ('203') THEN CIS2.NVAL(D.COL2) ELSE NULL END) AS R203_2,
  SUM(CASE WHEN D.RIND IN ('203') THEN CIS2.NVAL(D.COL3) ELSE NULL END) AS R203_3,
  SUM(CASE WHEN D.RIND IN ('204') THEN CIS2.NVAL(D.COL1) ELSE NULL END) AS R204_1,
  SUM(CASE WHEN D.RIND IN ('204') THEN CIS2.NVAL(D.COL2) ELSE NULL END) AS R204_2,
  SUM(CASE WHEN D.RIND IN ('204') THEN CIS2.NVAL(D.COL3) ELSE NULL END) AS R204_3,
  SUM(CASE WHEN D.RIND IN ('205') THEN CIS2.NVAL(D.COL1) ELSE NULL END) AS R205_1,
  SUM(CASE WHEN D.RIND IN ('205') THEN CIS2.NVAL(D.COL2) ELSE NULL END) AS R205_2,
  SUM(CASE WHEN D.RIND IN ('205') THEN CIS2.NVAL(D.COL3) ELSE NULL END) AS R205_3,
  SUM(CASE WHEN D.RIND IN ('206') THEN CIS2.NVAL(D.COL1) ELSE NULL END) AS R206_1,
  SUM(CASE WHEN D.RIND IN ('206') THEN CIS2.NVAL(D.COL2) ELSE NULL END) AS R206_2,
  SUM(CASE WHEN D.RIND IN ('206') THEN CIS2.NVAL(D.COL3) ELSE NULL END) AS R206_3,
  SUM(CASE WHEN D.RIND IN ('207') THEN CIS2.NVAL(D.COL1) ELSE NULL END) AS R207_1,
  SUM(CASE WHEN D.RIND IN ('207') THEN CIS2.NVAL(D.COL2) ELSE NULL END) AS R207_2,
  SUM(CASE WHEN D.RIND IN ('207') THEN CIS2.NVAL(D.COL3) ELSE NULL END) AS R207_3,
